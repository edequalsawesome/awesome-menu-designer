...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _mega_menu_edit__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _mega_menu_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mega-menu/edit */ "./src/mega-menu/edit.js");
// Export the mega menu edit component
...
/* harmony import */ var _shared_TemplateSelector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../shared/TemplateSelector */ "./src/shared/TemplateSelector.js");
...
function Edit({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, {
    ...
    autoComplete: "off"
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shared_TemplateSelector__WEBPACK_IMPORTED_MODULE_7__["default"], {
    value: menuSlug,
    onChange: value => setAttributes({
      menuSlug: value
    }),
...
/* harmony import */ var _shared_TemplateSelector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../shared/TemplateSelector */ "./src/shared/TemplateSelector.js");
...
const withMobileMenuControls = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_4__.createHigherOrderComponent)(BlockEdit => {
  return props => {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockEdit, {
      ...
      initialOpen: false
    }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shared_TemplateSelector__WEBPACK_IMPORTED_MODULE_6__["default"], {
      ...
      help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select a template to use as the mobile menu.', 'menu-designer')
    }))));
  };
}, 'withMobileMenuControls');

/**
 * Add mobile menu attributes to navigation block
 * @param {Object} settings - Block settings
 * @param {string} name - Block name
 * @return {Object} Modified settings
 */
const addMobileMenuAttributes = (settings, name) => {
  if (name !== 'core/navigation') {
    return settings;
  }
  return {
...
// Add filters
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__.addFilter)('editor.BlockEdit', 'ollie-mega-menu/with-mobile-menu-controls', withMobileMenuControls);
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_5__.addFilter)('blocks.registerBlockType', 'ollie-mega-menu/mobile-menu-attributes', addMobileMenuAttributes);

/***/ }),

/***/ "./src/shared/TemplateSelector.js":
/*!****************************************!*\
  !*** ./src/shared/TemplateSelector.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function TemplateSelector({
  ...
  const [iframeHeight, setIframeHeight] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)('600px');
  // State for loading
  const [isIframeLoading, setIsIframeLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(true);
  ...
  // Ensure siteUrl uses the same protocol as the current page
  const secureSiteUrl = siteUrl && window.location.protocol === 'https:' ? siteUrl.replace(/^http:\/\//, 'https://') : siteUrl || '';
  const menuTemplateUrl = secureSiteUrl ? secureSiteUrl + `/wp-admin/site-editor.php?postType=wp_template_part&categoryId=${templateArea}` : '';
  ...
  // Filter the template parts for those in the specified area.
  if (hasResolved) {
    templateOptions = records.filter(item => item.area === templateArea).map(item => ({
      label: item.title.rendered,
      value: item.slug
    }));
  }
  const hasTemplates = templateOptions.length > 0;
  const selectedTemplateAndExists = value ? templateOptions.some(option => option.value === value) : true;

  // Handle iframe load to measure its height
  const handleIframeLoad = event => {
    ...
    const measureHeight = () => {
      ...
      // Temporarily give iframe more height to measure content
      ...
      const heightWithPadding = contentHeight + 50; // 40px original padding + 10px extra
      const viewportHeight = window.innerHeight;
      const maxHeight = viewportHeight - 120; // Leave room for modal header

      // Set the appropriate height
      const finalHeight = heightWithPadding > maxHeight ? `${maxHeight}px` : `${heightWithPadding}px`;
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useState)(() => {
    if (isPreviewOpen) {
      setIsIframeLoading(true);
    }
  }, [isPreviewOpen, value]);
  const defaultHelp = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.createInterpolateElement)(hasTemplates ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(
  // translators: %s: template area name
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Manage %s templates in the <a>Site Editor</a>.', 'menu-designer'), templateArea) : (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)(
  // translators: %s: template area name
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No %s templates found. Create one now in the <a>Site Editor</a>.', 'menu-designer'), templateArea), {
  ...
  // Calculate modal width based on previewOptions
  const modalWidth = (() => {
    const {
      width,
      customWidth
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ComboboxControl, {
    ...
    marginTop: 5
  }), value && selectedTemplateAndExists && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.__experimentalHStack, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Button, {
    isSecondary: true,
    ...
    marginTop: 6
  })), isPreviewOpen && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Modal, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Template Preview: %s', 'menu-designer'), templateOptions.find(option => option.value === value)?.label || value),
    onRequestClose: () => {
      setIsPreviewOpen(false);
      setIframeHeight('600px'); // Reset height when closing
      setIsIframeLoading(true); // Reset loading state
    },
    className: "mega-menu-block-preview-modal",
    "aria-label": (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Preview template', 'menu-designer'),
    style: {
      maxWidth: '90%',
      width: modalWidth
    }
    ...
    style: {
      width: '100%',
      height: isIframeLoading ? '200px' : iframeHeight,
      transition: 'height 0.3s ease',
      overflow: 'hidden',
      position: 'relative'
    }
  }, isIframeLoading && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      position: 'absolute',
      top: '50%',
      left: '50%',
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Loading preview…', 'menu-designer'))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("iframe", {
    key: value // Force iframe to reload when value changes
    ,
    src: `${secureSiteUrl}/?ollie_mega_menu_preview=${value}`,
    style: {
      width: '100%',
      height: '100%',
      border: 'none',
